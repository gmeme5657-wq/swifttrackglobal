...
const EMAIL_TEMPLATES = {
  ...
  "Delivered":{subject:"Your package has been delivered", body:"Your package has arrived at its destination. Thanks for shipping with Swift Courier."},
  ...
  document.getElementById('email-preview-wrap').innerHTML = `
    <div class="email-card">
      <div class="email-card-head">
        <div style="font-family:var(--font-display);font-weight:700;font-size:16px;">Swift Courier</div>
      </div>
